      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="relative">
            ...
            <motion.a href="#contact" whileHover={{ scale: 1.02, boxShadow: '0 10px 35px rgba(251,191,36,0.35)' }} transition={{ duration: 0.25, ease: 'easeOut' }} className="mt-8 inline-flex items-center justify-center rounded-full bg-gradient-to-tr from-amber-400 to-cyan-300 text-black font-semibold px-6 py-3">Request a Proposal</motion.a>
          </div>
        </motion.div>
      </div>
    </section>
