  ...
  return (
    <section id="legacy" ref={ref} className="relative bg-[#0a0c10] text-white py-28 overflow-hidden">
      ...
      <div className="relative mt-14">
        <motion.div style={{ y: y1, opacity }} className="absolute inset-x-0 top-0 h-[320px] bg-[url('https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=1974&auto=format&fit=crop')] bg-cover bg-center mix-blend-luminosity will-change-transform" />
        <motion.div style={{ y: y2 }} className="relative z-10 will-change-transform">
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <motion.div key={item.year} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.9 }} className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6">
