  ...
  return (
    <section className="relative py-28">
      <div className="container mx-auto px-6">
        <motion.h2 initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9 }} className="text-3xl md:text-5xl font-extrabold">Process</motion.h2>
          ...
          <div className="space-y-8">
            {steps.map((s, i) => (
              <motion.div
                ...
                className="pl-10 will-change-transform"
              >
